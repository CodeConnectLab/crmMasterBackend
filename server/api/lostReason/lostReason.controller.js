...
const service = require("./lostReason.service")

exports.createLostReason=(req,res,next)=>{
    return service.createLostReason(req.body, req.user)
...
exports.getAllByCompany=(req,res,next)=>{
    ...
    .then(result => responseHandler.success(res, result, "Lost Reason creation successful!", 200))
    .catch(error => responseHandler.error(res, error, error.message, 500));
};
